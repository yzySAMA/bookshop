        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form role="form" action="${pageContext.request.contextPath}/update.do?pn=${pn}" method="post"
                ...
                <table class="table table-hover">
                   <tr>
                           ...
                           <div class="form-group">
                               <select class="form-control select2 " name="cid" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                   <c:forEach items="${categoryList}" var="cate">
                                        <c:if test="${cate.cid ==product.cid}">
                                            <option selected="selected" value="${cate.cid}">${cate.cname}</option>
                                        </c:if>
                                       <c:if test="${cate.cid !=product.cid}">
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" name="pname" class="form-control"
                                       id="exampleInputEmail1" placeholder="商品名称" value="${product.pname}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <textarea name="pdesc" id="" cols="30" rows="5" >${product.pdesc}</textarea>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                <div class="box-footer">
                    <button type="submit" class="update btn btn-primary">更新</button>
                </div>
            </form>
        </div>
    </div>
