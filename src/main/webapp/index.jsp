    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item"><h4>网络小说</h4></a>
                <a href="#" class="list-group-item"><h4>青春文学</h4></a>
                <a href="#" class="list-group-item"><h4>散文随笔</h4></a>
                <a href="#" class="list-group-item"><h4>科幻灵异</h4></a>
                <a href="#" class="list-group-item"><h4>世界名著</h4></a>
                <a href="#" class="list-group-item"><h4>人物传记</h4></a>
            </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" style="height: 350px; width: 900px;"
                             src="assets/img/pimage/new7.png" alt="First slide">
                    </div>
